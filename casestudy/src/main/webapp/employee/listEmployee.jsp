...
<h1 style="color: black;text-align: center">List Employee</h1>
...
<table class="table">
    <tr>
        ...
        <th style="color: darkred">Salary</th>
        <th style="color: darkred">Phone Number</th>
        <th style="color: darkred">Email</th>
        <th style="color: darkred">Address</th>
        <th style="color: darkred">Position Id</th>
        <th style="color: darkred">Education Degree Id</th>
        <th style="color: darkred">Division Id</th>
    ...
    <c:forEach var="employee" items="${listEmployee}" varStatus="status">
        <tr>
            ...
            <td><a href="/employee?action=delete&id=${employee.id}">
                <button type="button" class="btn" style="background: darkred;color: white" data-bs-toggle="modal"
                        data-bs-target="#exampleModal">
